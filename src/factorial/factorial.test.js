...
import getFactorial from './factotial'
...
describe('Unhappy Path', () => {
    test('getFactorial() should throw a a TypeError', () => {
        try {
            getFactorial()
        }catch({ name }) {
    ...
    test(`getFactorial() should throw a a TypeError with message "${typeErrorMessage}"`, () => {
        try {
            getFactorial()
        }catch({ message }) {
    ...
    test('getFactorial(<0) should return RangeError', () => {
        try{
            getFactorial(-1)
        }catch({ name }){
    ...
    test(`getFactorial(<0) should return RangeError with message "${rangeErrorMessage}"`, () => {
        try {
            getFactorial(-1)
        }catch({ message }) {
